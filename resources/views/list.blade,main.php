        ...
        <div class="search">
            <form>
                ...
                <div class="stock_search">
                    <input type="number" name="search_min_stock" placeholder="下限在庫" class="search_box string_box"> 
                    <p>{{__('~')}}</p>
                    <input type="number" name="search_max_stock" placeholder="上限在庫" class="search_box string_box">
                </div>
                <!--在庫検索ここまで-->
    ...
    <script>
        ...
        $('#search_button').on('click', function(){
            ...
            $.ajax({
                url: "{{ route('search') }}",
                method: "POST",
                data: { 'keyword' : keyword, 'company' : company, 'min_price' : min_price, 'max_price' : max_price, 'min_stock' : min_stock, 'max_stock' : max_stock },
                dataType: "json",
            }).done(function(res){
